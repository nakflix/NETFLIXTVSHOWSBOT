...
HEROKU_APP_NAME = os.environ.get("HEROKU_APP_NAME", "netflixlinkbot" )
...
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1001585995212"))
FORCE_SUB_GROUP = int(os.environ.get("FORCE_SUB_GROUP", "-1001909894765"))
